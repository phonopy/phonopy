...
def get_fc2_reciprocal( shortest_vectors, multiplicity,
                        q, p2s, s2p, fc2, symprec=1e-5 ):
    return get_py_fc2_reciprocal( shortest_vectors, multiplicity,
                                  q, p2s, s2p, fc2, symprec=1e-5 )
    ...
    for i in range(num_atom):
        for j in range(num_atom):
            for k in range(num_atom):
                fc3_q[ i, j, k] = \
                    get_fc3_sum_in_supercell( shortest_vectors,
                                              multiplicity,
                                              q_set,
                                              p2s_map,
                                              s2p_map,
