...
from anharmonic.phonon3.fc3 import set_translational_invariance_fc3_per_index, solve_fc3, distribute_fc3, third_rank_tensor_rotation
...
def _get_constrained_fc3(supercell,
    ...
    for disps_second in displacements['second_atoms']:
        ...
        if verbose > 1:
            print "Calculating delta fc3 for pair displacements(%d, %d)" % (
                atom1 + 1, atom2 + 1)
        solve_fc3(fc3,
                  atom2,
                  supercell,
