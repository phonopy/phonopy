...
```python
(
    np.dot(ph.displacements[0], np.linalg.inv(ph.supercell.cell))
...
```
% phonopy-init -f force-calcs/disp-{001..010}/vasprun.xml
```
...
```
% phonopy phonopy_disp_orig.yaml --rd 1000 --temperature 300
```
