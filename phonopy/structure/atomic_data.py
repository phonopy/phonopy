...
class AtomicData:
    """Class for atomic data."""

    symbol_map: dict[str, int] = dataclasses.field(
    ...
    # Pm: 145
    # Tc: 98
    atom_data: tuple[tuple[int, str, str, float | None], ...] = (
        (0, "X", "X", None),  # 0
    ...
    isotope_data_CIAAW: dict[str, tuple[tuple[int, float, float], ...]] = (
        dataclasses.field(
            default_factory=lambda: {
                "Mo": (
    ...
    isotope_data: dict[str, tuple[tuple[int, float, float], ...] | None] = (  # type: ignore
        dataclasses.field(
            default_factory=lambda: {
                ...
                "C": ((12, 12.0, 0.9893), (13, 13.003354838, 0.0107)),
